...
```kotlin
dependencies {
    implementation("io.github.rfaturriza:nona-config:1.0.3")
}
```
...
3. Set the **Dependency Rule** to **Up to Next Major Version** starting from `1.0.3`.
...
let package = Package(
    name: "MyApp",
    dependencies: [
        .package(url: "https://github.com/rfaturriza/NonaConfigKMP", from: "1.0.3")
    ],
    targets: [
        .target(
            name: "MyApp",
